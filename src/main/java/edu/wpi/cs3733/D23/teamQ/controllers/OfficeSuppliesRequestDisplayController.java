...
public class OfficeSuppliedRequestDisplayController {
    ...
    public void initialize() {
        ...
        quantityField.setText(String.valueOf(ListServiceRequestController.getOfficeRequest().getQuantity()));
    }
    ...
    public void updateButtonClicked() {
        ...
        qdb.updateOfficeSuppliesRequest(ListServiceRequestController.getFlowerRequest().getRequestID(), newOR);
    }
}
