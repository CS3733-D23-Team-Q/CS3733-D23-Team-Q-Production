...
public class PathfindingController {
    ...
    CheckBox servCheck;
    @FXML
    MFXFilterComboBox<String> startSelect;
    @FXML
    MFXFilterComboBox<String> endSelect;
    @FXML
    MFXComboBox<String> dateSelect;
    @FXML
    MFXComboBox<String> algorithmSelect;
    @FXML
    TextField messageField;
    @FXML
    MFXScrollPane textualPathfinding;
    @FXML
    VBox textArea;
    @FXML
    Label floorLabel;
                ...
                if (nodetype.equals("ELEV") || nodetype.equals("STAI")) {
                    ...
                    for (int j = 0; j < path.size(); j++) {
                        ...
                        if (fn.equals(n)) {
                            ...
                            */
                            if (previous != null) {
                                if (!fn.getFloor().equals(previous.getFloor())) {
                                    if (i > 0) {
                                        indexes.add(i - 1);
                                    }
                                }
