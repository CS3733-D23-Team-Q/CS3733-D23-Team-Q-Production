...
public class Qdb {
    ...
    private ConferenceRequestDaoImpl conferenceRequestTable = ConferenceRequestDaoImpl.getInstance(nodeTable);
    ...
    private FurnitureRequestDaoImpl furnitureRequestTable = FurnitureRequestDaoImpl.getInstance(nodeTable);
    private PatientTransportRequestDaoImpl patientTransportRequestTable = PatientTransportRequestDaoImpl.getInstance(nodeTable);
    private OfficeSuppliesRequestDaoImpl officeSuppliesRequestTable = OfficeSuppliesRequestDaoImpl.getInstance(nodeTable);
    private ServiceRequestDaoImpl serviceRequestTable = ServiceRequestDaoImpl.getInstance(conferenceRequestTable, flowerRequestTable, mealRequestTable, furnitureRequestTable, officeSuppliesRequestTable, patientTransportRequestTable);
