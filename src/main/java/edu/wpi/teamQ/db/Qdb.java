package edu.wpi.teamQ.db;

import edu.wpi.teamQ.db.impl.*;
import edu.wpi.teamQ.db.obj.*;
...
public class Qdb {
    ...
    private ServiceRequestDaoImpl serviceRequestTable = ServiceRequestDaoImpl.getInstance(conferenceRequestTable, flowerRequestTable);
    ...
    public ArrayList<ServiceRequest> retrieveAllServiceRequests() {
        return (ArrayList<ServiceRequest>) serviceRequestTable.getAllRows();
    }
